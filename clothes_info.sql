...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 11:43 AM
...
CREATE TABLE `clothes_info` (
  ...
  `clothes_brand` varchar(255) NOT NULL,
  `clothes_kind` varchar(255) NOT NULL,
...
INSERT INTO `clothes_info` (`clothes_id`, `clothes_brand`, `clothes_kind`, `clothes_size`, `clothes_price`) VALUES
(1, 'Memo', 'Dress', 'Large', 2000),
(2, 'Regatta', 'Tshirt', 'Medium', 899);
